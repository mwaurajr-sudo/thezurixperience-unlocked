...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "TheZuriXperience curates immersive nightlife and culture events. RnB nights, exclusive merch, DJ playlists, and the brands shaping the scene." },
      { name: "author", content: "TheZuriXperience" },
      { property: "og:title", content: "TheZuriXperience — Events, redefined" },
      { property: "og:description", content: "Immersive nightlife and culture events. Tickets, merch, playlists, and more." },
